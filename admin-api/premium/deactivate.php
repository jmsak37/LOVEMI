...
/*
|--------------------------------------------------------------------------
| LOVEMI ADMIN - DEACTIVATE PREMIUM API
|--------------------------------------------------------------------------
*/
...
try {
    ...
    if (
        ...
        throw new RuntimeException(
            'This premium subscription is not active.'
        );
    ...
    */
    ...
    $notification->execute(
        [
            ...
            ':message' =>
                'Your LOVEMI Premium subscription has been deactivated by administration.',
...
premiumDeactivateResponse(
    true,
    'Premium subscription deactivated successfully.',
    [
